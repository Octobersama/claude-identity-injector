...
func TestParseConfigStrictProfiles(t *testing.T) {
	profiles := []string{"minimum", "minimal", "bearer", "bearer_http1", "minimal_core", "identity", "system", "body", "body_core", "headers", "headers_soft", "body_headers", "body_headers_core", "full"}
